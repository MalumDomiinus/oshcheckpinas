      ...
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-elevated">
          <CardHeader>
            ...
            <CardDescription>
              {isLogin ? 'Sign in to access your dashboard' : isProvider ? 'Register to manage your training certificates' : 'Register to verify certificates'}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              {!isLogin && <>
                  <div className="space-y-2">
                    ...
                    <Input id="fullName" placeholder="Enter your full name" value={fullName} onChange={e => setFullName(e.target.value)} required={!isLogin} disabled={isLoading} />
                  </div>
              ...
              <div className="text-center text-sm">
                <button type="button" onClick={() => setIsLogin(!isLogin)} className="text-accent hover:underline" disabled={isLoading}>
